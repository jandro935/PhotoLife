    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed bootsnav">
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="./index.html"><img src="assets/imgs/logo.png" class="logo logo-scrolled" alt=""></a>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group{{ $errors->has('terms') ? ' has-error' : '' }}">
                            <div class="pull-left u-MarginTop15 text-muted u-MarginRight10">
                                <input type="checkbox" name="terms" required /> I agree with the <a href="#">Terms and Condition</a>
...
<!--footer start-->
<footer class="panel u-PaddingTop45 u-PaddingBottom45">
    <div class="container">
        <div class="row text-sm u-MarginTop20">

            <div class="col-md-5 col-sm-5">
                <p class="u-LineHeight2 u-MarginBottom20"><img class="retina logo-v-center u-PaddingRight20" src="assets/imgs/logo.png" alt=""> Copyright © 2009–2017 Alien Template.</p>
            </div>
            <div class="col-md-2 col-sm-2 text-center">
                <div class="social-links sl-default u-MarginTop10">
                    <a href="#">
                        <i class="fa fa-facebook"></i>
                    </a>
                    <a href="#">
            ...
            <div class="col-md-5 col-sm-5 text-right text-left--xs">
                <ul class="list-inline text-paragraph u-LineHeight2 u-MarginBottom0 u-MarginTop5">
                    <li><span class="footer-dash-sign dark"></span></li>
                    <li class="u-MarginRight10">Call <span class="dark-txt"> +123 456 789</span></li>

                    <li><span class="footer-dash-sign dark"></span></li>
                    <li>Email <span class="dark-txt"> info@alienemial.cm</span></li>
                </ul>
            </div>
        </div>
    </div>
